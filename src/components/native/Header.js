              ...
              <ul className="hidden w-8/12 -mr-32 md:flex items-center justify-center space-x-8">
                <li>
                  <a
                    ...
                    className="dark:text-white capitalize text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"
                  >
                    clothing
                  </a>
                </li>
              ...
              <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                <div className="hidden text-2xl lg:flex items-center space-x-4 xl:space-x-8">
                  ...
                  <div
                    ...
                    aria-label="go to cart"
                    className="text-gray-800 cursor-pointer flex dark:hover:text-gray-300 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800"
                  >
            ...
            <div className="mt-6 p-4">
              <ul className="flex flex-col  space-y-6">
                <li>
                  <a
                    href="/categories/clothing"
                    className="dark:text-white capitalize flex items-center justify-between hover:underline text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800"
                  >
                    clothing
                    <div>
                      <svg
