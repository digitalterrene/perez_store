      ...
      <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
        ...
        <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
          <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 ">
            {data && data.title ? `${data.title}` : "Product Title"}
          </h2>
          ...
          <p className=" font-normal text-base leading-6 text-gray-600 mt-7">
            {data && data.long_desc ? `${data.long_desc}` : "Description"}
          </p>
          <p className=" font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 ">
            {data && data.price ? `R ${data.price}` : "R ___"}
          </p>
      ...
      <div className="flex  justify-center items-center w-full">
        <div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10">
          {data &&
            ...
            data.specs.map((s, i) => (
              <div key={i}>
                <img className="h-10 w-10 mr-2" src={s.icon} alt={s.title} />
