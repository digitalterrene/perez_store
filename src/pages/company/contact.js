...
export default function contact() {
  ...
  return (
    <div className="h-screen w-full">
      <div
        style={{
          backgroundImage: `url(${"https://cdn.pixabay.com/photo/2016/09/01/14/06/about-us-1636180_960_720.jpg"})`,
        }}
        className="bg-gradient-to-b  bg-no-repeat bg-cover bg-center h-96 w-full"
      >
        ...
        <div className="w-full flex items-center h-full justify-center my-12">
