...
export default function Profile2() {
  ...
  return (
    <div className="w-full ">
      {" "}
      <form className="w-full bg-red-800" id="login" onSubmit={handleSubmit}>
        <div className="bg-white dark:bg-gray-800">
          <div className="container mx-auto bg-white dark:bg-gray-800 rounded">
            <div className="w-full border-b border-gray-300 dark:border-gray-700 py-5 bg-white dark:bg-gray-800">
          ...
          <div className="container mx-auto bg-white dark:bg-gray-800 mt-10 rounded px-4">
            ...
            <div className="mx-auto pt-4">
              <div className="container flex flex-wrap mx-auto">
                <div className="w-1/4 mr-10 flex flex-col   mb-6">
                  <label
                    htmlFor="FirstName"
                    className="pb-2 text-sm font-bold text-gray-800 dark:text-gray-100"
                  >
                ...
                <div className="w-1/2 mr-full flex flex-col mb-6">
                  <label
                    htmlFor="Email"
                    className="pb-2 text-sm font-bold text-gray-800 dark:text-gray-100"
                  >
